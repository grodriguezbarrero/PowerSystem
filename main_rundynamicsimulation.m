...
isim_wg = 4;
plot(ha3,c_t_wg{isim_wg},c_WGpenetration_wg{isim_wg},'Color',v_colours(1));hold on;
isim_wg = isim_wg - 1;
plot(ha3,c_t_wg{isim_wg},c_WGpenetration_wg{isim_wg},'Color',v_colours(2));hold on;
isim_wg = isim_wg - 1;
plot(ha3,c_t_wg{isim_wg},c_WGpenetration_wg{isim_wg},'Color',v_colours(3));hold on;
isim_wg = isim_wg - 1;
plot(ha3,c_t_wg{isim_wg},c_WGpenetration_wg{isim_wg},'Color',v_colours(4));hold on;
